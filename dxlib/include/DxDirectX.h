...
//	#include <stdio.h>
	...
	#define D_DSBSTATUS_BUFFERLOST					DSBSTATUS_BUFFERLOST
	#define D_DSBSTATUS_LOOPING						DSBSTATUS_LOOPING
	#define D_DSBSTATUS_LOCHARDWARE					DSBSTATUS_LOCHARDWARE
	#define D_DSBSTATUS_LOCSOFTWARE					DSBSTATUS_LOCSOFTWARE
	#define D_DSBSTATUS_TERMINATED					DSBSTATUS_TERMINATED
