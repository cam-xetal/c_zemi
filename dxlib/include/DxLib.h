...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x308a
#define DXLIB_VERSION_STR _T( "3.08a" )
...
#define DX_BASEIMAGE_FORMAT_ABGR_I16		(6)			// ARGB16ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_ABGR_F16		(7)			// ARGB16ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_ABGR_F32		(8)			// ARGB32ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_ONE_I8			(9)			// １チャンネル8ビット整数型
#define DX_BASEIMAGE_FORMAT_ONE_I16			(10)		// １チャンネル16ビット整数型
#define DX_BASEIMAGE_FORMAT_ONE_F16			(11)		// １チャンネル16ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_ONE_F32			(12)		// １チャンネル32ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_TWO_I8			(13)		// ２チャンネル8ビット整数型
#define DX_BASEIMAGE_FORMAT_TWO_I16			(14)		// ２チャンネル16ビット整数型
#define DX_BASEIMAGE_FORMAT_TWO_F16			(15)		// ２チャンネル16ビット浮動小数点型
#define DX_BASEIMAGE_FORMAT_TWO_F32			(16)		// ２チャンネル32ビット浮動小数点型
...
extern	int			RefreshDxLibDirect3DSetting( void ) ;															// ＤＸライブラリのＤｉｒｅｃｔ３Ｄ設定をしなおす
...
extern	int			DrawPolygonIndexed2DToShader( VERTEX2DSHADER *Vertex, int VertexNum, unsigned short *Indices, int PolygonNum ) ;	// シェーダーを使って２Ｄポリゴンを描画する(インデックス)
extern	int			DrawPolygonIndexed3DToShader( VERTEX3DSHADER *Vertex, int VertexNum, unsigned short *Indices, int PolygonNum ) ;	// シェーダーを使って３Ｄポリゴンを描画する(インデックス)
...
extern	int			DrawPrimitiveIndexed2DToShader( VERTEX2DSHADER *Vertex, int VertexNum, unsigned short *Indices, int IndexNum, int PrimitiveType /* DX_PRIMTYPE_TRIANGLELIST 等 */ ) ;	// シェーダーを使って２Ｄプリミティブを描画する(インデックス)
extern	int			DrawPrimitiveIndexed3DToShader( VERTEX3DSHADER *Vertex, int VertexNum, unsigned short *Indices, int IndexNum, int PrimitiveType /* DX_PRIMTYPE_TRIANGLELIST 等 */ ) ;	// シェーダーを使って３Ｄプリミティブを描画する(インデックス)
...
extern	int			CreateGraphFromMem( void *RGBFileImage, int RGBFileImageSize, void *AlphaFileImage = NULL , int AlphaFileImageSize = 0 , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																					// メモリ上のグラフィックイメージからグラフィックハンドルを作成する
extern	int			ReCreateGraphFromMem( void *RGBFileImage, int RGBFileImageSize, int GrHandle, void *AlphaFileImage = NULL , int AlphaFileImageSize = 0 , int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																	// メモリ上のグラフィックイメージから既存のグラフィックハンドルにデータを転送する
extern	int			CreateDivGraphFromMem( void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE , void *AlphaFileImage = NULL , int AlphaFileImageSize = 0 ) ;			// メモリ上のグラフィックイメージから分割グラフィックハンドルを作成する
extern	int			ReCreateDivGraphFromMem( void *RGBFileImage, int RGBFileImageSize, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE , void *AlphaFileImage = NULL , int AlphaFileImageSize = 0 ) ;		// メモリ上のグラフィックイメージから既存の分割グラフィックハンドルにデータを転送する
...
extern	int			CreateGraphFromGraphImage( BASEIMAGE *RGBImage, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																																					// GraphImageデータからグラフィックハンドルを作成する
extern	int			CreateGraphFromGraphImage( BASEIMAGE *RGBImage, BASEIMAGE *AlphaImage, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																															// GraphImageデータからグラフィックハンドルを作成する
extern	int			ReCreateGraphFromGraphImage( BASEIMAGE *RGBImage, int GrHandle, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																																	// GraphImageデータから既存のグラフィックハンドルにデータを転送する
extern	int			ReCreateGraphFromGraphImage( BASEIMAGE *RGBImage, BASEIMAGE *AlphaImage, int GrHandle, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																											// GraphImageデータから既存のグラフィックハンドルにデータを転送する
extern	int			CreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																			// GraphImageデータから分割グラフィックハンドルを作成する
extern	int			CreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, BASEIMAGE *AlphaImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;													// GraphImageデータから分割グラフィックハンドルを作成する
extern	int			ReCreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;																		// GraphImageデータから既存の分割グラフィックハンドルにデータを転送する
extern	int			ReCreateDivGraphFromGraphImage( BASEIMAGE *RGBImage, BASEIMAGE *AlphaImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag = TRUE , int ReverseFlag = FALSE ) ;													// GraphImageデータから既存の分割グラフィックハンドルにデータを転送する
extern	int			CreateGraph( int Width, int Height, int Pitch, void *RGBImage, void *AlphaImage = NULL , int GrHandle = -1 ) ;																																		// メモリ上のグラフィックデータからグラフィックハンドルを作成する
extern	int			CreateDivGraph( int Width, int Height, int Pitch, void *RGBImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, void *AlphaImage = NULL ) ;																					// メモリ上のグラフィックデータから分割グラフィックハンドルを作成する
extern	int			ReCreateGraph( int Width, int Height, int Pitch, void *RGBImage, int GrHandle, void *AlphaImage = NULL ) ;																																			// メモリ上のグラフィックデータからグラフィックハンドルを再作成する
...
extern	int			SetCreateDrawValidGraphChannelNum( int ChannelNum ) ;				// 作成する描画可能な画像のチャンネル数を設定する,SetDrawValidGraphCreateFlag 関数で描画可能画像を作成するように設定されていないと効果がない
extern	int			GetCreateDrawValidGraphChannelNum( void ) ;							// 作成する描画可能な画像のチャンネル数を取得する
...
extern	int			AddStreamSoundMemToMem( void *FileImage, int FileImageSize, int LoopNum,  int SoundHandle, int StreamDataType, int UnionHandle = -1 ) ;	// ストリーム風サウンドデータにサウンドデータを追加する
...
extern	int			LoadSoundMem2( const TCHAR *FileName1, const TCHAR *FileName2 ) ;											// 前奏部とループ部に分かれたサウンドデータの作成
extern	int			LoadBGM( const TCHAR *FileName ) ;																		// 主にＢＧＭを読み込むのに適した関数

extern	int			LoadSoundMemBase( const TCHAR *FileName, int BufferNum, int UnionHandle = -1 ) ;							// サウンドデータを追加する
extern	int			LoadSoundMem( const TCHAR *FileName, int BufferNum = 3 , int UnionHandle = -1 ) ;						// サウンドデータを追加する
extern	int			LoadSoundMemToBufNumSitei( const TCHAR *FileName, int BufferNum ) ;										// 同時再生数指定型サウンド追加関数
...
extern	int			LoadSoundMemByMemImageBase( void *FileImage, int FileImageSize, int BufferNum, int UnionHandle = -1 ) ; // メモリ上に展開されたファイルイメージからハンドルを作成する(ベース関数)
extern	int			LoadSoundMemByMemImage( void *FileImage, int FileImageSize, int UnionHandle = -1 ) ;					// メモリ上に展開されたファイルイメージからハンドルを作成する(バッファ数指定あり) 
extern	int			LoadSoundMemByMemImage2( void *WaveImage, int WaveImageSize, WAVEFORMATEX *WaveFormat, int WaveHeaderSize ) ;	// メモリ上に展開されたファイルイメージからハンドルを作成する2
extern	int			LoadSoundMemByMemImageToBufNumSitei( void *FileImage, int FileImageSize, int BufferNum ) ;				// メモリ上に展開されたファイルイメージからハンドルを作成する
extern	int			LoadSoundMem2ByMemImage( void *FileImage1, int FileImageSize1, void *FileImage2, int FileImageSize2 ) ;	// メモリ上に展開されたファイルイメージから前奏部とループ部に分かれたハンドルを作成する
...
extern	int			LoadSoftSoundFromMemImage( const void *FileImage, int FileImageSize ) ;									// ソフトウエアで扱う波形データをメモリ上に展開されたファイルイメージから作成する
...
extern	int			MakeSoftSoundCustom( int ChannelNum, int BitsPerSample, int SamplesPerSec, int SampleNum );				// ソフトウエアで扱う空の波形データを作成する
...
extern	int			MakeSoftSoundPlayerCustom( int ChannelNum, int BitsPerSample, int SamplesPerSec ) ;						// ソフトウエアで扱う波形データのプレイヤーを作成する
...
extern	int			LoadMusicMemByMemImage( void *FileImage, int FileImageSize ) ;											// メモリ上に展開されたＭＩＤＩファイルを読み込む
...
extern	int			SetVolumeMusicMem( int Volume, int MusicHandle ) ;														// ＭＩＤＩデータの再生音量をセットする
